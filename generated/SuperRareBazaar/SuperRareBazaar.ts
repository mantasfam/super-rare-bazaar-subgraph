...
export class SuperRareBazaar__auctionBidsResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: i32;
...
export class SuperRareBazaar__getAuctionDetailsResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SuperRareBazaar__getSalePriceResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
...
export class SuperRareBazaar__tokenAuctionsResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SuperRareBazaar__tokenCurrentOffersResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: i32;
...
export class SuperRareBazaar__tokenSalePricesResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
...
export class SuperRareBazaar extends ethereum.SmartContract {
  static bind(address: Address): SuperRareBazaar {
    return new SuperRareBazaar("SuperRareBazaar", address);
  }
  ...
  auctionBids(
    param0: Address,
    param1: BigInt
  ): SuperRareBazaar__auctionBidsResult {
    let result = super.call(
      "auctionBids",
    ...
    return new SuperRareBazaar__auctionBidsResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toI32()
  ...
  try_auctionBids(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<SuperRareBazaar__auctionBidsResult> {
    let result = super.tryCall(
      "auctionBids",
      "auctionBids(address,uint256):(address,address,uint256,uint8)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SuperRareBazaar__auctionBidsResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toI32()
  ...
  getAuctionDetails(
    ...
    _tokenId: BigInt
  ): SuperRareBazaar__getAuctionDetailsResult {
    let result = super.call(
      "getAuctionDetails",
    ...
    return new SuperRareBazaar__getAuctionDetailsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getAuctionDetails(
    _originContract: Address,
    _tokenId: BigInt
  ): ethereum.CallResult<SuperRareBazaar__getAuctionDetailsResult> {
    let result = super.tryCall(
      "getAuctionDetails",
      "getAuctionDetails(address,uint256):(address,uint256,uint256,uint256,address,uint256,bytes32,address[],uint8[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SuperRareBazaar__getAuctionDetailsResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getSalePrice(
    ...
    _tokenId: BigInt,
    _target: Address
  ): SuperRareBazaar__getSalePriceResult {
    let result = super.call(
      "getSalePrice",
    ...
    return new SuperRareBazaar__getSalePriceResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
  ...
  try_getSalePrice(
    ...
    _tokenId: BigInt,
    _target: Address
  ): ethereum.CallResult<SuperRareBazaar__getSalePriceResult> {
    let result = super.tryCall(
      "getSalePrice",
      "getSalePrice(address,uint256,address):(address,address,uint256,address[],uint8[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SuperRareBazaar__getSalePriceResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
  ...
  tokenAuctions(
    param0: Address,
    param1: BigInt
  ): SuperRareBazaar__tokenAuctionsResult {
    let result = super.call(
      "tokenAuctions",
    ...
    return new SuperRareBazaar__tokenAuctionsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_tokenAuctions(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<SuperRareBazaar__tokenAuctionsResult> {
    let result = super.tryCall(
      "tokenAuctions",
      "tokenAuctions(address,uint256):(address,uint256,uint256,uint256,address,uint256,bytes32)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SuperRareBazaar__tokenAuctionsResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  tokenCurrentOffers(
    ...
    param1: BigInt,
    param2: Address
  ): SuperRareBazaar__tokenCurrentOffersResult {
    let result = super.call(
      "tokenCurrentOffers",
    ...
    return new SuperRareBazaar__tokenCurrentOffersResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toI32(),
  ...
  try_tokenCurrentOffers(
    ...
    param1: BigInt,
    param2: Address
  ): ethereum.CallResult<SuperRareBazaar__tokenCurrentOffersResult> {
    let result = super.tryCall(
      "tokenCurrentOffers",
      "tokenCurrentOffers(address,uint256,address):(address,uint256,uint256,uint8,bool)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SuperRareBazaar__tokenCurrentOffersResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toI32(),
  ...
  tokenSalePrices(
    ...
    param1: BigInt,
    param2: Address
  ): SuperRareBazaar__tokenSalePricesResult {
    let result = super.call(
      "tokenSalePrices",
    ...
    return new SuperRareBazaar__tokenSalePricesResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt()
    );
  ...
  try_tokenSalePrices(
    ...
    param1: BigInt,
    param2: Address
  ): ethereum.CallResult<SuperRareBazaar__tokenSalePricesResult> {
    let result = super.tryCall(
      "tokenSalePrices",
      "tokenSalePrices(address,uint256,address):(address,address,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SuperRareBazaar__tokenSalePricesResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt()
      )
